...
public class TijoloProjectileRenderer extends EntityRenderer<TijoloProjectileEntity> {
	...
	public TijoloProjectileRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new ModelTijoloProjetil(context.bakeLayer(ModelTijoloProjetil.LAYER_LOCATION));
	}

	@Override
	public void render(TijoloProjectileEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(TijoloProjectileEntity entity) {
		return texture;
	}
}