...
public class MolotovArremessarOnDispenseAttemptWithResultProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Direction direction) {
		...
		if (world instanceof ServerLevel projectileLevel) {
			Projectile _entityToSpawn = initArrowProjectile(createArrowWeaponItemStack(new MolotovProjectileEntity(NoirSmpModEntities.MOLOTOV_PROJECTILE.get(), 0, 0, 0, projectileLevel), 5, (byte) 0), null, 10, true, false, false,
					AbstractArrow.Pickup.DISALLOWED);
			_entityToSpawn.setPos(fromX, fromY, fromZ);
			_entityToSpawn.shoot((direction.getStepX()), (direction.getStepY()), (direction.getStepZ()), 1, 1);
