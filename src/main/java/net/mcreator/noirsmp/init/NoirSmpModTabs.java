...
public class NoirSmpModTabs {
	...
	public static final RegistryObject<CreativeModeTab> NOIR_SMP = REGISTRY.register("noir_smp",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.noir_smp.noir_smp")).icon(() -> new ItemStack(NoirSmpModItems.MANOPLA_DE_SLIME.get())).displayItems((parameters, tabData) -> {
