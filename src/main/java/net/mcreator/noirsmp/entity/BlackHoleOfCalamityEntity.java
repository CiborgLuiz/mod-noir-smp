...
public class BlackHoleOfCalamityEntity extends Monster {
	...
	public BlackHoleOfCalamityEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(NoirSmpModEntities.BLACK_HOLE_OF_CALAMITY.get(), world);
	}

	public BlackHoleOfCalamityEntity(EntityType<BlackHoleOfCalamityEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(1f);
		xpReward = 0;
		setNoAi(false);
	...
	public static AttributeSupplier.Builder createAttributes() {
		...
		builder = builder.add(Attributes.MAX_HEALTH, 1012);
