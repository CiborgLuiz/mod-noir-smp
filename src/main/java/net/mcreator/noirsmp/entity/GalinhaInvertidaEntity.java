...
public class GalinhaInvertidaEntity extends Monster {
	public GalinhaInvertidaEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(NoirSmpModEntities.GALINHA_INVERTIDA.get(), world);
	}

	public GalinhaInvertidaEntity(EntityType<GalinhaInvertidaEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 4;
		setNoAi(false);
	...
	public static void init() {
		SpawnPlacements.register(
				NoirSmpModEntities.GALINHA_INVERTIDA.get(),
	...
	public static AttributeSupplier.Builder createAttributes() {
		...
		builder = builder.add(Attributes.MAX_HEALTH, 30D);
		builder = builder.add(Attributes.ARMOR, 2D);
		builder = builder.add(Attributes.ATTACK_DAMAGE, 4D);
