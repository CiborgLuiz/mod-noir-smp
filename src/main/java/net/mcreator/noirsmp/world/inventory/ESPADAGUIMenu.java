package net.mcreator.noirsmp.world.inventory;
...
import net.mcreator.noirsmp.network.ESPADAGUISlotMessage;
...
public class ESPADAGUIMenu extends AbstractContainerMenu implements NoirSmpModMenus.MenuAccessor {
	...
	public ESPADAGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(NoirSmpModMenus.ESPADAGUI.get(), id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 80, 56) {
			private final int slot = 0;
			private int x = ESPADAGUIMenu.this.x;
			private int y = ESPADAGUIMenu.this.y;
			...
			public boolean mayPlace(ItemStack stack) {
				return stack.is(ItemTags.create(new ResourceLocation("noir:espada")));
			}
		}));
		...
		this.customSlots.put(3, this.addSlot(new SlotItemHandler(internal, 3, 134, 56) {
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			NoirSmpMod.PACKET_HANDLER.sendToServer(new ESPADAGUISlotMessage(slotid, x, y, z, ctype, meta));
			ESPADAGUISlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
