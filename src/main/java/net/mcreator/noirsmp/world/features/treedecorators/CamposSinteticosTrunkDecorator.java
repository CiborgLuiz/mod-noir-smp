...
public class CamposSinteticosTrunkDecorator extends TrunkVineDecorator {
	public static Codec<CamposSinteticosTrunkDecorator> CODEC = Codec.unit(CamposSinteticosTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("campos_sinteticos_tree_trunk_decorator", DECORATOR_TYPE));
	}
