package net.mcreator.noirsmp.world.features.treedecorators;
...
public class CamposSinteticosFruitDecorator extends CocoaDecorator {
	public static Codec<CamposSinteticosFruitDecorator> CODEC = Codec.unit(CamposSinteticosFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("campos_sinteticos_tree_fruit_decorator", DECORATOR_TYPE));
	}

	public CamposSinteticosFruitDecorator() {
		super(0.2f);
	}
